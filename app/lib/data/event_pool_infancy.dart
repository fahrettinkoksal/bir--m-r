...
const List<GameEvent> kInfancyEvents = <GameEvent>[
  ...
  GameEvent(
    ...
    text:
        'Gecenin ortasında uyandın. Evde ışıklar tek tek yanıyor, '
    ...
    choices: <EventChoice>[
      EventChoice(
        ...
        label: 'Ninniyle uyu',
        resultText:
            '{sahip} aynı ninniyi üçüncü kez söylerken uyudun. '
      ...
      EventChoice(
        ...
        resultText:
            'Ev halkı sırayla seni gezdirdi. Sabah kimse '
  ...
  GameEvent(
    ...
    category: EventCategory.aile,
    text:
        'Ateşin çıktı. Alnına konan el, termometre, telaşlı bir telefon '
    ...
    choices: <EventChoice>[
      EventChoice(
        ...
        resultText:
            'Nöbetçi doktor "geçer" dedi ve geçti. Dönüş yolunda '
            'arabada uyuyakaldın.',
        happiness: -1,
        health: 3,
        bond: 5,
      ...
      EventChoice(
        ...
        resultText:
            'Islak bez, sık sık ölçülen ateş ve hiç kapanmayan bir '
  ...
  GameEvent(
    ...
    category: EventCategory.aile,
    text:
        'Bugün birkaç saatliğine başkasına bırakılacaksın. Kapıda elin '
    ...
    choices: <EventChoice>[
      EventChoice(
        ...
        resultText:
            'Kapı kapandıktan beş dakika sonra oyuna daldın. '
      ...
      EventChoice(
        ...
        resultText:
            'Hiç zorlanmadan girdin. Akşam anlatacak o kadar çok '
  ...
  GameEvent(
    ...
    category: EventCategory.aile,
    text:
        'Yeni bir kelime keşfettin: "neden?" Günde yüz kere soruyorsun '
    ...
    choices: <EventChoice>[
      EventChoice(
        ...
        resultText:
            '{sahip} bazılarına cevap veremedi ve "bilmiyorum, '
      ...
      EventChoice(
        ...
        resultText:
            'Dolapları, çekmeceleri, kutuları açtın. Bazı sorular '
  ...
  GameEvent(
    ...
    category: EventCategory.aile,
    text:
        'Masada tek mumlu bir pasta var. Herkes fotoğraf çekmeye hazır, '
    ...
    choices: <EventChoice>[
      EventChoice(
        ...
        resultText:
            'Fotoğrafların en iyisi o an çekildi: iki yanağın da '
      ...
      EventChoice(
        ...
        resultText:
            'Mum söndürüldü, ışıklar açıldı. Ağlaman geçtiğinde '
  ...
  GameEvent(
    ...
    category: EventCategory.aile,
    text:
        '{sahip} yine bebekliğine dair o hikâyeyi anlatıyor. Anlatırken '
    ...
    choices: <EventChoice>[
      EventChoice(
        ...
        resultText:
            'Ezbere bildiğin hikâyeyi yine dinledin. Anlatanın '
      ...
      EventChoice(
        ...
        label: '"Tamam, yeter"',
        resultText:
            'Konuyu kapattın. Sonra bir ara, kimse yokken kendi '
            'kendine gülümsedin.',
        happiness: 2,
      ),
    ],
